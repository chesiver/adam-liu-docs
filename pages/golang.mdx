...
I feel like nothing is more accurate than golang's official spec, but reading the spec could be really time-consuming.
So I quote some important concepts here which I think be crucial for understanding golang's type system and generics.
