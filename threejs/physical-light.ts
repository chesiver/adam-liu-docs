...
export default function PhysicalLightExample(mountRef: MutableRefObject<HTMLDivElement>) {
    const container = mountRef.current;
    const width = container.clientWidth, height = 800;
    let camera, scene, renderer = new WebGLRenderer(), bulbLight: PointLight, bulbMat, hemiLight;
    ...
    function init() {
        ...
        textureLoader.load('/threejs/textures/hardwood2_diffuse.jpg', function (map) {
        ...
        textureLoader.load('/threejs/textures/hardwood2_bump.jpg', function (map) {
            map.wrapS = RepeatWrapping;
            map.wrapT = RepeatWrapping;
            map.anisotropy = 4;
            map.repeat.set(10, 24);
        ...
        textureLoader.load('/threejs/textures/hardwood2_roughness.jpg', function (map) {
            map.wrapS = RepeatWrapping;
            map.wrapT = RepeatWrapping;
            map.anisotropy = 4;
            map.repeat.set(10, 24);
        ...
        textureLoader.load('/threejs/textures/brick_diffuse.jpg', function (map) {
            map.wrapS = RepeatWrapping;
            map.wrapT = RepeatWrapping;
            map.anisotropy = 4;
            map.repeat.set(1, 1);
        ...
        textureLoader.load('/threejs/textures/brick_bump.jpg', function (map) {
            map.wrapS = RepeatWrapping;
            map.wrapT = RepeatWrapping;
            map.anisotropy = 4;
            map.repeat.set(1, 1);
        ...
        textureLoader.load('/threejs/textures/earth_atmos_2048.jpg', function (map) {
            map.anisotropy = 4;
            map.colorSpace = SRGBColorSpace;
            ballMat.map = map;
            ballMat.needsUpdate = true;
        });
        textureLoader.load('/threejs/textures/earth_specular_2048.jpg', function (map) {
            map.anisotropy = 4;
            map.colorSpace = SRGBColorSpace;
